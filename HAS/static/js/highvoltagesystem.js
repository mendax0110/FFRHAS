...
const iframeSrcTemp1 = `http://${host}:3000/d-solo/Highvoltagesystem?orgId=1&panelId=1&from=now-30m&to=now&timezone=browser&refresh=1s`;
const iframeSrcTemp2 = `http://${host}:3000/d-solo/Highvoltagesystem?orgId=1&panelId=2&from=now-30m&to=now&timezone=browser&refresh=1s`;
const iframeSrcPressure = `http://${host}:3000/d-solo/Highvoltagesystem?orgId=1&panelId=3&from=now-30m&to=now&timezone=browser&refresh=1s`;
